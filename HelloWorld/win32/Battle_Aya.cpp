...
Battle_Aya::Battle_Aya(int cTag)
{
	init();
	...
	setTag(cTag);
	this->autorelease();
	this->setResourceWithString("aya");
	m_iCharacterName = CN_HERO_AYA;
...
void Battle_Aya::doCard(const Action_Card &card)
{
	...
	switch (card.getCardNumber())
	{
		...
		case AC_ATTACK5:
		{
						   ...
						   m_listOrder.push_back(
							   ...
							   shared_ptr<kwMsg_Action>(
							   new kwMsg_Action(
							   new kwMoving_Vector(this, 800.f, CG3Point(x, 0, 0)),
							   m_pMap->getCurrentTargetPointer(),
							   50,
							   combineInt(1, 1),
							   1.f,
							   NULL,//new kwMoving_Vector(this, 200.f, CG3Point(1, 0, 0)),
							   CG3Point(x * 100, 0, 200),
							   CG3Point(500, 100, 200),
							   CG3Point(0, 0, 0)
							   )),
